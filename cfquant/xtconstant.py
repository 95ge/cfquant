...
QMT_CREDIT_BUY = 33
QMT_CREDIT_SELL = 34
QMT_CREDIT_FIN_BUY_SPECIAL = 70
QMT_CREDIT_SLO_SELL_SPECIAL = 71
QMT_CREDIT_BUY_SECU_REPAY_SPECIAL = 72
QMT_CREDIT_DIRECT_SECU_REPAY_SPECIAL = 73
QMT_CREDIT_SELL_SECU_REPAY_SPECIAL = 74
QMT_CREDIT_DIRECT_CASH_REPAY_SPECIAL = 75
QMT_CREDIT_ORDER_TYPE_MAP = {
    CREDIT_BUY: QMT_CREDIT_BUY,
    CREDIT_SELL: QMT_CREDIT_SELL,
    CREDIT_FIN_BUY: CREDIT_FIN_BUY,
    CREDIT_SLO_SELL: CREDIT_SLO_SELL,
    CREDIT_BUY_SECU_REPAY: CREDIT_BUY_SECU_REPAY,
    CREDIT_DIRECT_SECU_REPAY: CREDIT_DIRECT_SECU_REPAY,
    CREDIT_SELL_SECU_REPAY: CREDIT_SELL_SECU_REPAY,
    CREDIT_DIRECT_CASH_REPAY: CREDIT_DIRECT_CASH_REPAY,
    CREDIT_FIN_BUY_SPECIAL: QMT_CREDIT_FIN_BUY_SPECIAL,
    CREDIT_SLO_SELL_SPECIAL: QMT_CREDIT_SLO_SELL_SPECIAL,
    CREDIT_BUY_SECU_REPAY_SPECIAL: QMT_CREDIT_BUY_SECU_REPAY_SPECIAL,
    CREDIT_DIRECT_SECU_REPAY_SPECIAL: QMT_CREDIT_DIRECT_SECU_REPAY_SPECIAL,
    CREDIT_SELL_SECU_REPAY_SPECIAL: QMT_CREDIT_SELL_SECU_REPAY_SPECIAL,
    CREDIT_DIRECT_CASH_REPAY_SPECIAL: QMT_CREDIT_DIRECT_CASH_REPAY_SPECIAL,
}
FUTURE_OPEN_LONG = 0
...
QMT_STOCK_OPTION_BUY_OPEN = 50
QMT_STOCK_OPTION_SELL_CLOSE = 51
QMT_STOCK_OPTION_SELL_OPEN = 52
QMT_STOCK_OPTION_BUY_CLOSE = 53
QMT_STOCK_OPTION_COVERED_OPEN = 54
QMT_STOCK_OPTION_COVERED_CLOSE = 55
QMT_STOCK_OPTION_CALL_EXERCISE = 56
QMT_STOCK_OPTION_PUT_EXERCISE = 57
QMT_STOCK_OPTION_SECU_LOCK = 58
QMT_STOCK_OPTION_SECU_UNLOCK = 59
QMT_STOCK_OPTION_ORDER_TYPE_MAP = {
    STOCK_OPTION_BUY_OPEN: QMT_STOCK_OPTION_BUY_OPEN,
    STOCK_OPTION_SELL_CLOSE: QMT_STOCK_OPTION_SELL_CLOSE,
    STOCK_OPTION_SELL_OPEN: QMT_STOCK_OPTION_SELL_OPEN,
    STOCK_OPTION_BUY_CLOSE: QMT_STOCK_OPTION_BUY_CLOSE,
    STOCK_OPTION_COVERED_OPEN: QMT_STOCK_OPTION_COVERED_OPEN,
    STOCK_OPTION_COVERED_CLOSE: QMT_STOCK_OPTION_COVERED_CLOSE,
    STOCK_OPTION_CALL_EXERCISE: QMT_STOCK_OPTION_CALL_EXERCISE,
    STOCK_OPTION_PUT_EXERCISE: QMT_STOCK_OPTION_PUT_EXERCISE,
    STOCK_OPTION_SECU_LOCK: QMT_STOCK_OPTION_SECU_LOCK,
    STOCK_OPTION_SECU_UNLOCK: QMT_STOCK_OPTION_SECU_UNLOCK,
}
...
ORDER_TYPE_SET = {
    ...
    QMT_CREDIT_BUY,
    QMT_CREDIT_SELL,
    QMT_CREDIT_FIN_BUY_SPECIAL,
    QMT_CREDIT_SLO_SELL_SPECIAL,
    QMT_CREDIT_BUY_SECU_REPAY_SPECIAL,
    QMT_CREDIT_DIRECT_SECU_REPAY_SPECIAL,
    QMT_CREDIT_SELL_SECU_REPAY_SPECIAL,
    QMT_CREDIT_DIRECT_CASH_REPAY_SPECIAL,
    FUTURE_OPEN_LONG,
    ...
    QMT_STOCK_OPTION_BUY_OPEN,
    QMT_STOCK_OPTION_SELL_CLOSE,
    QMT_STOCK_OPTION_SELL_OPEN,
    QMT_STOCK_OPTION_BUY_CLOSE,
    QMT_STOCK_OPTION_COVERED_OPEN,
    QMT_STOCK_OPTION_COVERED_CLOSE,
    QMT_STOCK_OPTION_CALL_EXERCISE,
    QMT_STOCK_OPTION_PUT_EXERCISE,
    QMT_STOCK_OPTION_SECU_LOCK,
    QMT_STOCK_OPTION_SECU_UNLOCK,
    OPTION_FUTURE_OPTION_EXERCISE,
    COMPOSE_OPEN_LONG,
    COMPOSE_OPEN_SHORT,
    COMPOSE_CLOSE_LONG_TODAY_FIRST,
    COMPOSE_CLOSE_LONG_HISTORY_FIRST,
    COMPOSE_CLOSE_SHORT_TODAY_FIRST,
    COMPOSE_CLOSE_SHORT_HISTORY_FIRST,
    COMPOSE_ONEKEY_FUTURE_TODAY_FIRST,
    COMPOSE_ONEKEY_FUTURE_HISTORY_FIRST,
    COMPOSE_FUTURE_ADJUST_TODAY_FIRST,
    COMPOSE_FUTURE_ADJUST_HISTORY_FIRST,
    COMPOSE_OPTION_COMB_EXERCISE,
    COMPOSE_OPTION_BUILD_COMB_STRATEGY,
    COMPOSE_OPTION_RELEASE_COMB_STRATEGY,
    FUTURE_HEDGE,
}
