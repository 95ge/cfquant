# fe7a33f6-b89b-4e2c-b3ef-68b71761204b implementation handoff

This archive is the source of truth for turning the design into production code. Start from `cfquant-official-site-prototype-v2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `cfquant-official-site-prototype-v2.html`
...
- A single self-contained `cfquant-official-site-prototype-v2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `cfquant-official-site-prototype-v2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `cfquant-official-site-prototype-v2.html`
- `cfquant-official-site-prototype-v3.html`
- `cfquant-official-site-prototype.html`
...
- `项目架构图.md`
- `brand-spec.md`
- `opendesign_official_site_redesign_requirements.md`

## Coding checklist for AI tools
1. Inspect `cfquant-official-site-prototype-v2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
